...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="o-f-inp">
                                ...
                                <select id="filter-category" class="form-select shadow-none search-select">
                        ...
                        @can('knowledge-base.create')
                            <div class="col-lg-3 ms-auto mt-4">
                                <a href="{{ route('admin.knowledge-bases.create') }}" class="add-btn">Add Knowledge Base</a>
                            </div>
                        @endcan
                    </div>
                    <div class="row">
    ...
    @include('admin.knowledge.modal.modal')
@endsection

@section('scripts')
    @include('admin.scripts.script')
    @include('admin.knowledge.js')
@endsection