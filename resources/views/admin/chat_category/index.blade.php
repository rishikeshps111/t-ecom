        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title">
                    <h3>Knowledge Base Category Management</h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 mb-3">
                <div class="main-table-container">
                    <div class="row">
                        ...
                        @can('knowledge-base-category.create')
                            <div class="col-lg-3 ms-auto mt-4">
                                <a href="{{ route('admin.chat-categories.create') }}" class="add-btn">Add Category</a>
                            </div>
                        @endcan
                    </div>
                    <div class="row">
...
@section('scripts')
    ...
    @include('admin.chat_category.js')
@endsection