                ...
                <form method="GET" id="searchForm">
                    <div class="row">
                        ...
                        <div class="col-lg-3 ms-auto">
                            <a href="{{route('admin.business.owner.create')}}" class="add-btn">Add</a>
                        </div>
                    </div>
                </form>
                <div class="row">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-7">
                                    <div class="entry-select">
                                        <p>Showing</p>
                                        <form method="GET" action="{{route('admin.manage.business.owner')}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-btns">
                                                    <a href="{{route('admin.business.owner.edit',$user->id)}}" class="btn-edit"> <i class="fa-solid fa-pen-to-square" aria-hidden="true"></i></a>

                                                    <a href="#!" class="btn-delete" onclick="confirmDelete({{ $user->id }})"> <i class="fa-solid fa-trash"
                                                            aria-hidden="true"></i></a>
                                                    <form id="delete-user-{{ $user->id }}" action="{{route('admin.business.owner.destroy',$user->id)}}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </div>
