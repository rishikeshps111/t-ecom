<script>
    $(function () {
        let table = $('#table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.account-statements.credit-notes') }}",
            ...
            columns: [
                ...
                { data: 'credit_note_number', name: 'credit_note_number' },
        ...
        $('#exportSelected').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    link.download = 'credit-note-report.pdf';
