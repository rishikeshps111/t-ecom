<script>
    ...
    $(document).ready(function () {
        ...
        function calculatePlannerCommission() {
            ...
            $('#totalPlannerCommissionPercentage').text(billToPPercentage.toFixed(5));
    ...
    <div class="row item-row mb-3">
        ...
        <div class="col-lg-3 mb-2 o-f-inp">
            ...
            <input type="number" step="0.01" name="items[${itemIndex}][production_iv]" class="form-control shadow-none"
                value="${data.production_iv ?? ''}" readonly>
        </div>
        <div class="col-lg-1 mb-3 o-f-inp d-none">
            <label>UMO<span class="text-danger">*</span></label>
        ...
        <div class="col-lg-12 mb-2 o-f-inp">
            ...
            style="resize: none; overflow: hidden;">${data.description ?? ''}</textarea>
        </div>
