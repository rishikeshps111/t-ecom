        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title">
                    <h3 class="d-flex justify-content-between align-items-center">Items Management <span>Add</span></h3>
                </div>
            </div>
        </div>
                ...
                <div class="main-table-container">
                    <form action="{{ route('admin.item.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">User <span class="text-danger">*</span>@error('user_id') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                            ...
                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">Company <span class="text-danger">*</span>@error('company_id') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                            ...
                            <div class="col-lg-12 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="planner_commission"
                                        ...
                                        {{ old('planner_commission') ? 'checked' : '' }}>
                            ...
                            <div
                                class="col-lg-6 mb-3 o-f-inp planner-fields {{ old('planner_commission') ? '' : 'd-none' }}">
                                <label>Planner IV % <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="planner_iv_percentage"
                                    value="{{ old('planner_iv_percentage') }}" class="form-control shadow-none">
                            ...
                            <div class="col-lg-12 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="production_commission"
                                        ...
                                        {{ old('production_commission') ? 'checked' : '' }}>
                            ...
                            <div
                                class="col-lg-6 mb-3 o-f-inp production-fields {{ old('production_commission') ? '' : 'd-none' }}">
                                <label>Production IV % <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="production_iv_percentage"
                                    value="{{ old('production_iv_percentage') }}" class="form-control shadow-none">
                            ...
                            <div class="col-lg-6 mb-3 o-f-inp">
                                <label>SST %</label>
                                <input type="number" step="0.01" name="stt" value="{{ old('stt') }}"
                            ...
                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">Selling Price <span class="text-danger">*</span>@error('selling_price') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                            ...
                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">Cost Price <span class="text-danger">*</span>@error('cost_price') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                                <input type="text" class="form-control shadow-none" name="cost_price">
                            </div>

                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">Commission Factor (%) <span
                                        class="text-danger">*</span>@error('commission_factor') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                                <input type="number" step="0.01" min="0" class="form-control shadow-none"
                                    name="commission_factor" id="commission_factor">
                            </div>
                            ...
                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">Tax Group <span class="text-danger">*</span>@error('tax_group') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                                <select name="tax_group" id="tax_group" class="form-select shadow-none">
                                    ...
                                    <option value="6">Service Tax 6%</option>
                            ...
                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">Unit of Measure (UOM)<span class="text-danger">*</span>@error('uom') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                                <input type="text" class="form-control shadow-none" name="uom">
                            </div>
                            <div class="col-lg-4 mb-3 o-f-inp">
                            ...
                            <div class="col-lg-4 mb-3 o-f-inp">
                                <label for="">Weight<span class="text-danger">*</span>@error('weight') <small
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                                <input type="text" class="form-control shadow-none" name="weight">
                            </div>
                            ...
                            <div class="col-lg-12 mb-3 o-f-inp">
                                <label for="">Short Description<span class="text-danger">*</span>@error('short_description')
                                    <small class="text-danger">{{ $message }}</small> @enderror</label>
                                <textarea class="form-control shadow-none" name="short_description"></textarea>
                            </div>
                            ...
                            <div class="col-lg-12 mb-3 o-f-inp">
                                <label for="">Detailed Description<span
                                        ...
                                        class="text-danger">{{ $message }}</small> @enderror</label>
                                <textarea class="form-control shadow-none" name="detail_description"></textarea>
                            </div> --}}
